...
angular.module('APIMATICCalculatorLib')
    .factory('CalculatorDevOpsConf', ['$q',
        'Configuration',
        'HttpClient',
        'APIHelper',
        'BaseController',
        CalculatorDevOpsConf
    ]);

    function CalculatorDevOpsConf($q, Configuration, HttpClient, APIHelper, BaseController) {
        return {
            /**
             ...
             */
            calculateDevOpsStamford: function (operation, x, y) {
